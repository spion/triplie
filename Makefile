...
triplie: main.o ai/tokens.o irc/IRC.o ai/ai.o ai/dictionary.o ai/markov.o ai/graph.o
	${CXX} ${CXXFLAGS} -o triplie main.o ai/ai.o ai/tokens.o irc/IRC.o ai/dictionary.o ai/markov.o ai/graph.o -I. -I./ai -I./IRC

cmdtriplie: maincmdline.o ai/ai.o ai/tokens.o ai/dictionary.o ai/markov.o ai/graph.o
	${CXX} ${CXXFLAGS} -o cmdtriplie maincmdline.o ai/ai.o ai/tokens.o ai/dictionary.o ai/markov.o ai/graph.o -I. -I./ai
